...
function openSettings(){
  ...
  // New designer fields
  const _pcH1=document.getElementById('s-pc-headline1'); if(_pcH1) _pcH1.value=c.postcardHeadline1||'It might be time for a new roof.';
  const _pcH2=document.getElementById('s-pc-headline2'); if(_pcH2) _pcH2.value=c.postcardHeadline2||'But don\'t worry, we can help!';
  const _pcBadgeTxt=document.getElementById('s-pc-badge-text'); if(_pcBadgeTxt) _pcBadgeTxt.value=c.postcardBadgeText||'';
  ...
  const _pcBackBadgeTxt=document.getElementById('s-pc-back-badge-text'); if(_pcBackBadgeTxt) _pcBackBadgeTxt.value=c.postcardBackBadgeText||'';
  ...
  const _epShowPrice=document.getElementById('s-ep-show-price'); if(_epShowPrice) _epShowPrice.checked=c.estimatePageShowPrice!==false;
...
function saveSettings(){
  ...
  S.cfg={
    ...
    estimatePageShowPrice:!!(document.getElementById('s-ep-show-price')&&document.getElementById('s-ep-show-price').checked),
  ...
  // Refresh GBB buttons with new labels/colors
  if (typeof refreshGBBButtons === 'function') refreshGBBButtons();
