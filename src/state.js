...
const DEFAULTS = {
  ...
  hookLetter:'Every roof tells a story. Yours says it might be time for new shingles. We measured your home from satellite imagery to give you an accurate starting estimate — no scheduled visit required.',
  whyReceived:'We identified your home because your roof shows possible signs of age or wear. This estimate is based on satellite measurements and may vary after an on-site inspection. You control the next step — scan the QR code to schedule your free in-home inspection now.',
  postcardHook:'Every roof tells a story. Yours says it might be time for new shingles. We measured your home from satellite imagery to give you an accurate starting estimate — no scheduled visit required.',
  postcardWhy:'We identified your home because your roof shows possible signs of age or wear. This estimate is based on satellite measurements and may vary after an on-site inspection. You control the next step — scan the QR code to schedule your free in-home inspection now.',
  postcardQuote:'',
