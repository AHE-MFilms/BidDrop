...
const TRADE_POSTCARD_COPY_DEFAULTS = {
  roofing:    { headline1:'We Assessed', headline2:'Your Roof.', hook:'We tapped your house on the map. Your estimate is already built — no sales visit, no pressure, just your price.', why:'We use satellite imagery and property data to identify homes in your area that are due for a roof evaluation. Your property came up based on age, condition indicators, and neighborhood activity.', quote:'"They replaced our roof in one day, no mess, no drama." — Mike D.', guarantee:'Tap a house. We build the bid. You close the deal.' },
  solar:      { headline1:'Go Solar,', headline2:'Save More.', hook:'The average homeowner saves $1,400/year with solar. We make it simple — no pushy sales, just your custom proposal.', why:'We use satellite imagery to identify homes in your area with ideal roof orientation and sun exposure for solar. Your property came up as a strong candidate.', quote:'"Our electric bill dropped to almost zero." — Sarah T.', guarantee:'Free solar assessment. No obligation.' },
  gutters:    { headline1:'Protect', headline2:'Your Home.', hook:'Clogged or damaged gutters cause foundation damage, basement flooding, and rot. We\'ll give you a straight price — no games.', why:'We use property data to identify homes in your area where gutters may need attention. Your property came up based on age and condition indicators.', quote:'"Fast install, great price, no mess left behind." — Tom R.', guarantee:'Free gutter assessment. No pressure.' },
  siding:     { headline1:'New Siding,', headline2:'New Look.', hook:'We tapped your house on the map. Your siding estimate is already built — no pressure, no back-and-forth.', why:'We use satellite imagery and property data to identify homes in your area that may need siding work. Your property came up based on age and condition indicators.', quote:'"Our home looks brand new. Neighbors keep asking who did it." — Lisa M.', guarantee:'Free siding assessment. No obligation.' },
  windows:    { headline1:'New Windows,', headline2:'Lower Bills.', hook:'Old windows leak energy and money. We give you a straight price — no pushy sales, no games.', why:'We use property data to identify homes in your area with older windows that may be affecting energy efficiency. Your property came up based on age and condition indicators.', quote:'"The difference in our energy bill was immediate." — Dave K.', guarantee:'Free window assessment. No pressure.' },
  ...
  paint:      { headline1:'Fresh Paint,', headline2:'Fresh Start.', hook:'Faded or peeling exterior paint hurts your home\'s value. We give you a straight price — no games, no pressure.', why:'We use property data to identify homes in your area where exterior paint may need attention. Your property came up based on age and condition indicators.', quote:'"Our house looks incredible. Best money we\'ve spent." — James P.', guarantee:'Free exterior paint assessment. No pressure.' },
  doors:      { headline1:'New Doors,', headline2:'Better Security.', hook:'Old doors leak energy and compromise security. We give you a straight price — no pushy sales, no games.', why:'We use property data to identify homes in your area with older doors that may need replacement. Your property came up based on age and condition indicators.', quote:'"The new front door completely transformed our home\'s look." — Amy S.', guarantee:'Free door assessment. No obligation.' },
  fencing:    { headline1:'New Fence,', headline2:'More Privacy.', hook:'We tapped your house on the map. Your fencing estimate is already built — no games, no pressure.', why:'We use satellite imagery and property data to identify properties in your area that may need fencing work. Your property came up based on condition and neighborhood activity.', quote:'"Beautiful fence, installed in one day, great price." — Bob W.', guarantee:'Free fencing assessment. No pressure.' },
};
