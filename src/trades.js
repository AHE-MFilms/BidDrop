...
const TRADE_POSTCARD_COPY_DEFAULTS = {
  roofing:    { headline1:'It might be time for a new roof.', headline2:'But don\'t worry, we can help!', hook:'We tapped your roof on the map. Satellite data measured it. Your price was built before this arrived — no appointment needed, no one coming to your door.', why:'Public property records show your roof is likely past the 20-year mark. Recent hail or high-wind activity was logged in your ZIP code. Neighbors on your street have pulled roofing permits recently. Satellite imagery flagged wear consistent with aging shingles. No obligation — this is just your number, ready when you are.', quote:'"They replaced our roof in one day, no mess, no drama." — Mike D.', guarantee:'Your price. Built by satellite. No visit required.' },
  ...
  paint:      { headline1:'Fresh Paint,', headline2:'Fresh Start.', hook:'Faded or peeling exterior paint hurts your home\'s value. We give you a straight price — no games, no visit required.', why:'We use property data to identify homes in your area where exterior paint may need attention. Your property came up based on age and condition indicators.', quote:'"Our house looks incredible. Best money we\'ve spent." — James P.', guarantee:'Free exterior paint assessment. No visit required.' },
  doors:      { headline1:'New Doors,', headline2:'Better Security.', hook:'Old doors leak energy and compromise security. We give you a straight price — no games, no visit required.', why:'We use property data to identify homes in your area with older doors that may need replacement. Your property came up based on age and condition indicators.', quote:'"The new front door completely transformed our home\'s look." — Amy S.', guarantee:'Free door assessment. No visit required.' },
  fencing:    { headline1:'New Fence,', headline2:'More Privacy.', hook:'We tapped your house on the map. Your fencing estimate is already built — no games, no visit required.', why:'We used satellite imagery to assess your property. Your lot showed indicators that fencing may be a fit.', quote:'"Beautiful fence, installed in one day, great price." — Bob W.', guarantee:'Free fencing assessment. No visit required.' },
};
...
function renderTradePostcardAccordion(){
  ...
  const COPY_FIELDS = [
    ...
    { key:'guarantee', label:'Guarantee / CTA', placeholder:'e.g. Your price. Built by satellite. No visit required.', type:'input' },
  ];
