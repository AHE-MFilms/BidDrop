...
function selectTrade(tradeId){
  ...
  const _addSolarBtn = document.getElementById('solar-autofill-kw-btn');
...
const TRADE_POSTCARD_COPY_DEFAULTS = {
  roofing:    { headline1:'It might be time for a new roof.', headline2:'But don\'t worry, we can help!', hook:'We prepared a project estimate for your home using satellite imagery and current pricing data. This is a starting point to help you plan — your contractor will verify the details before any work begins.', why:'We specialize in accurate roofing estimates built from satellite data, so you have a realistic number before any conversation starts. No pressure, no surprises — just transparent pricing from a local crew that stands behind its work.', quote:'', guarantee:'Prepared from satellite data. Your contractor will verify details on-site.' },
  solar:      { headline1:'Go Solar,', headline2:'Save More.', hook:'The average homeowner saves $1,400/year with solar. We make it simple — no games, just your custom proposal.', why:'We used satellite imagery to analyze your roof’s orientation and sun exposure. Your property shows strong potential for solar generation.', quote:'', guarantee:'Prepared from satellite data. Your contractor will verify details on-site.' },
  gutters:    { headline1:'Protect', headline2:'Your Home.', hook:'Clogged or damaged gutters cause foundation damage, basement flooding, and rot. We\'ll give you a straight price — no games.', why:'We use property data to identify homes in your area where gutters may need attention. Your property came up based on age and condition indicators.', quote:'', guarantee:'Prepared from satellite data. Your contractor will verify details on-site.' },
  siding:     { headline1:'New Siding,', headline2:'New Look.', hook:'We prepared a project estimate for your home using satellite imagery and current pricing data. This is a starting point to help you plan — your contractor will verify the details before any work begins.', why:'We used satellite imagery to assess your home’s exterior condition. Your property showed indicators that siding may need attention.', quote:'', guarantee:'Prepared from satellite data. Your contractor will verify details on-site.' },
  windows:    { headline1:'New Windows,', headline2:'Lower Bills.', hook:'Old windows leak energy and money. We give you a straight price — transparent pricing, no pressure.', why:'We use property data to identify homes in your area with older windows that may be affecting energy efficiency. Your property came up based on age and condition indicators.', quote:'', guarantee:'Prepared from satellite data. Your contractor will verify details on-site.' },
  insulation: { headline1:'Stay Warm,', headline2:'Spend Less.', hook:'Poor insulation is the #1 cause of high energy bills. We\'ll assess your home and give you a straight price.', why:'We use property data to identify homes in your area that may benefit from insulation upgrades. Your property came up based on age and energy efficiency indicators.', quote:'"Our heating bill dropped 30% after the insulation upgrade." — Carol B.', guarantee:'Free insulation assessment. No obligation.' },
  paint:      { headline1:'Fresh Paint,', headline2:'Fresh Start.', hook:'Faded or peeling exterior paint hurts your home\'s value. We give you a straight price — transparent pricing, no pressure.', why:'We use property data to identify homes in your area where exterior paint may need attention. Your property came up based on age and condition indicators.', quote:'"Our house looks incredible. Best money we\'ve spent." — James P.', guarantee:'Prepared from satellite data. Your contractor will verify details on-site.' },
  doors:      { headline1:'New Doors,', headline2:'Better Security.', hook:'Old doors leak energy and compromise security. We give you a straight price — transparent pricing, no pressure.', why:'We use property data to identify homes in your area with older doors that may need replacement. Your property came up based on age and condition indicators.', quote:'"The new front door completely transformed our home\'s look." — Amy S.', guarantee:'Prepared from satellite data. Your contractor will verify details on-site.' },
  fencing:    { headline1:'New Fence,', headline2:'More Privacy.', hook:'We prepared a project estimate for your home using satellite imagery and current pricing data. This is a starting point to help you plan — your contractor will verify the details before any work begins.', why:'We used satellite imagery to assess your property. Your lot showed indicators that fencing may be a fit.', quote:'', guarantee:'Prepared from satellite data. Your contractor will verify details on-site.' },
};
...
function renderTradePostcardAccordion(){
  ...
  const COPY_FIELDS = [
    { key:'headline1', label:'Headline Line 1', placeholder:'e.g. It might be time for a new roof.', type:'input' },
    ...
    { key:'guarantee', label:'Guarantee / CTA', placeholder:'e.g. Prepared from satellite data. Your contractor will verify details on-site.', type:'input' },
  ];
