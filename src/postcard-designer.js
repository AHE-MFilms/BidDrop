...
function pdThumbnailHtml(id, meta) {
  const thumbs = {
    ...
    't7': `<div class="pd-tpl-thumb-inner" style="background:#111;position:relative;overflow:hidden;">
...
/* ─── Template t7: Neighborhood Alert ───────────────────────── */
...
function pdBackHtml() {
  ...
  return `
    ...
    <div data-zone="heroImage" class="pd-zone" style="position:absolute;top:30%;right:0;width:48%;bottom:10px;border-left:1px dashed #ddd;overflow:hidden;cursor:pointer;" title="Click to upload hero image">
